        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <address className="space-y-2">
              <p className="text-gray-400">Email: <a href="mailto:info@carrental.com" className="hover:text-white">info@carrental.com</a></p>
              <p className="text-gray-400">Phone: +123 456 7890</p>
              <p className="text-gray-400">Address: 123 Car Street, City, Country</p>
            </address>
          </div>
        </div>
      </div>
